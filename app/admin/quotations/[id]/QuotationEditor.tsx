...
export function QuotationEditor({quotation,items,request,cameras,accessories,kits,rates,supplierItems,isAdmin}:any){
  ...
  const [savingAction,setSavingAction]=useState<"draft"|"generate"|"delete"|null>(null);const [message,setMessage]=useState("");const saving=!!savingAction;
