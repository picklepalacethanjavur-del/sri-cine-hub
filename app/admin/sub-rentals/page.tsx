...
export default async function SubRentalsPage(){
  ...
  return <section className="adminShell"><div className="eyebrow">EXTERNAL EQUIPMENT</div><h1>Sub-Rentals</h1><AdminNav/>{error&&<div className="errorBox">{error.message}</div>}<SubRentalManager initialRows={data||[]}/></section>;
}
